...
import { getPayment } from '../fn/cart-controller/get-payment';
import { GetPayment$Params } from '../fn/cart-controller/get-payment';
...
export class CartControllerService extends BaseService {
  ...
  static readonly GetPaymentPath = '/api/v1/carts';
...
*/
  getCartItems$Response(params: GetCartItems$Params, context?: HttpContext): Observable<StrictHttpResponse<Cart>> {
    const rb = new RequestBuilder(this.rootUrl, CartControllerService.GetCartItemsPath, 'get');
    if (params) {
  ...
  static readonly GetCartPath = '/api/v1/carts/get-user-cart';
